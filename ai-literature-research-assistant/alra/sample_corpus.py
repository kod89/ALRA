"""
Fallback biomedical literature corpus for portfolio demo mode.
"""
...
SAMPLE_PAPERS = [
    ...
    {
        "title": "Hyaluronic acid filler degradation behavior and formulation stability in aesthetic medicine",
        "abstract": (
            "This review analyzes hyaluronic acid filler durability, crosslinking chemistry, "
            "and formulation stability in aesthetic medicine. The literature indicates that "
            "crosslink density and rheology strongly influence persistence and tissue response. "
            "However, comparative long-term safety data across commercial formulations remain sparse."
        ),
    ...
    {
        "title": "Collagen-based biomaterials for implantable medical devices: biocompatibility and processing trends",
        "abstract": (
            "Collagen-derived biomaterials are increasingly used in implantable devices due to "
            "their biocompatibility and tunable processing. Recent studies focus on crosslinking "
            "methods, sterilization effects, and tissue integration. Key gaps remain in batch "
            "consistency, degradation control, and long-term comparative clinical performance."
        ),
        "journal": "Biomaterials Advances",
        "year": 2025,
        "doi": "10.1016/j.bioadv.2025.213456",
    },
    {
        "title": "Tissue compatibility evaluation strategies for biomaterials used in aesthetic reconstruction",
        "abstract": (
            "This paper reviews preclinical and translational approaches for evaluating tissue "
            "compatibility in biomaterials intended for aesthetic reconstruction. The evidence "
            "supports multi-modal assessment across inflammation, fibrosis, and integration, "
            "but standardized outcome frameworks are still limited."
        ),
